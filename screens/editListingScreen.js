...
import { editProp } from '../redux/props/actions';
...
class EditListing extends Component{
    ...
    handleClick = () => {
        ...
        this.props.editProp(data, this.onSuccess, this.onError);
                ...
                <ScrollView>
                    <KeyboardAvoidingView style={styles.container} enabled={true} behavior='padding' keyboardVerticalOffset={keyboardVerticalOffset}>
                        ...
                        <CustomInputWithLabel
                            ...
                            labelStyle={styles.label}
                            inputs={{onChangeText: (title) => this.setState({unit_desc}) , style: styles.inputStyle, multiline: true, value: this.state.unit_desc}}
                        />
                        <CustomPicker 
                            label='Category:'
                            labelStyle={styles.label}
