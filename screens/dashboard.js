...
import { updateProp, delProp } from '../redux/props/actions';
...
class Dashboard extends Component{
  ...
  //////////////////////////////////////////////////////////////
    ...
    deleteRow = (rowMap, rowKey) => {
        ...
        this.props.delProp({rowMap,rowKey}, this.closeRow, this.onError);
    ...
    _onRefresh = () => {
        ...
        this.props.updateProp( this.onSuccess, this.onError )
    }
