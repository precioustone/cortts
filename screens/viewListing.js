...
import { Alert, CameraRoll, PermissionsAndroid, StyleSheet, ScrollView, Text, TouchableOpacity, View } from 'react-native';
...
class ViewListing extends Component{
    ...
    createPdf = async () => {
        ...
        //let writePath = `/storage/emulated/0/cortts/${this.props.property.title}.pdf`;
        let destPath = 'Documents';
        

        let options = {
            html,
            fileName: this.props.property.title,
            directory: destPath,
        };
        ...
        showMessage({
            message: 'Pdf was saved in '+file.filePath,
            type: "success",
        });
    ...
    requestStoragePermission = async () => {
        try {
          ...
          && granted['android.permission.WRITE_EXTERNAL_STORAGE'] === PermissionsAndroid.RESULTS.GRANTED) {
            ...
            Alert.alert('Error occured when requesting for permission');
        }
      }
    ...
    viewPhotos = () => {
        ...
        navigate('ViewPhotos', {id: this.props.navigation.getParam('id'), title: this.props.property.title, images: this.props.property.photos});
    };
        ...
        return (
            this.state.fontLoaded && ( <View style={styles.container}>
                ...
                <ActionButton buttonColor="#26B469">
                    ...
                    <ActionButton.Item buttonColor='#3498db' title="Save As pdf" onPress={ this.requestStoragePermission }>
